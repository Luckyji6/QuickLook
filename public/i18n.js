(function () {
  ...
  const strings = {
    en: {
      ...
      open: 'Open',
      hint: 'Tip: You can also start with: quicklook /path/to/photos',
      ...
      noPhotos: 'No photos or videos found in this directory',
      exit: 'Exit (Esc)',
      selected: 'Selected',
      previewHint: 'Space: select | Enter hold: 3x video | ← →: switch | Esc: exit',
      video: 'VIDEO',
      copyModalTitle: 'Batch copy',
      copyModalDesc: 'Copy {count} selected items to target directory',
    ...
    zh: {
      ...
      open: '打开',
      hint: '提示：可通过命令行指定目录启动，如 quicklook /path/to/photos',
      selectedCount: '已选',
      photos: '项',
      batchCopy: '批量复制',
      ...
      parsingDate: '正在解析日期...',
      noPhotos: '该目录下没有找到图片或视频',
      exit: '退出 (Esc)',
      selected: '已选中',
      previewHint: '空格: 选中/取消 | 按住 Enter: 视频 3 倍速 | ← →: 切换 | Esc: 退出',
      video: '视频',
      copyModalTitle: '批量复制',
      copyModalDesc: '将选中的 {count} 项复制到目标目录',
